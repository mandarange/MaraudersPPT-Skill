...
<svg
  ...
  xmlns="http://www.w3.org/2000/svg"
  role="img"
  aria-label="Donut chart showing market share"
>
  <style>
    .donut-label {
      font:
...
<svg
  ...
  xmlns="http://www.w3.org/2000/svg"
  role="img"
  aria-label="Trend line showing upward growth"
>
  <style>
    .spark-line {
      fill: none;
...
```html
<polyline
  points="10,12 40,18 70,26 100,30 130,38 160,42 190,48"
  class="spark-line"
  stroke="#D94F4F"
/>
...
<svg
  ...
  xmlns="http://www.w3.org/2000/svg"
  role="img"
  aria-label="Process flow: Input to Output"
>
  <defs>
    <!-- Arrow marker -->
    <marker
  ...
  <rect
    ...
    width="120"
    height="100"
    class="step-box step-box-active"
  />
  <text x="410" y="65" text-anchor="middle" class="step-no step-no-active">
    03
  </text>
  <text
    x="410"
    y="90"
    text-anchor="middle"
    class="step-label step-label-active"
  >
    Map
  </text>
...
>
  ...
  <text x="300" y="135" text-anchor="middle" class="tl-event">
    Chart Support
  </text>
  <text x="300" y="152" text-anchor="middle" class="tl-desc">
    8 chart types
  </text>
  ...
  <text x="480" y="135" text-anchor="middle" class="tl-event">
    AI Automation
  </text>
...
<!-- Curved connector -->
<path
  d="M 50,80 C 100,80 100,120 150,120"
  stroke="#CCCCCC"
  stroke-width="1.5"
  fill="none"
  marker-end="url(#arr-light)"
/>

<!-- Right-angle connector -->
<polyline
  points="50,150 100,150 100,200 150,200"
  stroke="#1A1A1A"
  stroke-width="1.5"
  fill="none"
  marker-end="url(#arr-dark)"
...
<div class="kpi-card">
  ...
  <div style="display: flex; align-items: center; gap: 16px;">
    ...
    >
      <polygon
        points="5,35 20,30 40,28 60,22 80,18 100,12 115,8 115,38 5,38"
        fill="#1A1A1A"
        opacity="0.06"
      />
      <polyline
        points="5,35 20,30 40,28 60,22 80,18 100,12 115,8"
        fill="none"
        stroke="#1A1A1A"
        stroke-width="2"
        stroke-linecap="round"
...
>
  ...
  <text x="300" y="40" text-anchor="middle" class="node-text node-text-active">
    Start
  </text>
